...
export function TemplateHintDialog({ hint, files, onClose, onApply }: TemplateHintDialogProps) {
  ...
  return (
    <DialogShell className="template-hint-dialog" labelledBy="template-hint-title" onClose={onClose}>
      <DialogHeader title={title} titleId="template-hint-title" onClose={onClose} lead={hint.message} />
