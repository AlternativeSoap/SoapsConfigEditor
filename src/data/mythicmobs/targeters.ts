...
export const TARGETERS: TargeterEntry[] = [
  ...
  { id: 'NotLivingNearOrigin', shorthand: ['@NLNO'], kind: 'entity', description: 'Targets all non-living entities in a radius near the origin', insertSnippet: '@NotLivingNearOrigin{r=5}' },
  ...
  { id: 'EntitiesInRadius', shorthand: ['@EIR', '@livingInRadius', '@allInRadius'], kind: 'entity', description: 'Targets all entities in the given radius', insertSnippet: '@EntitiesInRadius{r=10}' },
  ...
  // Single-location
  { id: 'SelfLocation', shorthand: ['@casterLocation', '@mobLocation'], kind: 'location', description: 'Targets the caster\'s location', insertSnippet: '@SelfLocation' },
  { id: 'SelfEyeLocation', shorthand: ['@eyeDirection', '@casterEyeLocation'], kind: 'location', description: 'Targets the caster\'s eye location', insertSnippet: '@SelfEyeLocation' },
  ...
  { id: 'TargetPredictedLocation', shorthand: ['@TPL'], kind: 'location', description: 'Targets the predicted location of the caster\'s target', insertSnippet: '@TargetPredictedLocation{ticks=10}' },
  ...
  { id: 'Location', shorthand: [], kind: 'location', description: 'Targets the specified coordinates in the caster\'s world', insertSnippet: '@Location{coordinates=0,64,0}' },
  ...
  { id: 'RandomLocationsNearOrigin', shorthand: ['@RLO', '@RLNO'], kind: 'location', description: 'Targets random locations near the origin', insertSnippet: '@RandomLocationsNearOrigin{r=5;amount=3}' },
  ...
  // Meta-entity
  { id: 'LivingInLine', shorthand: ['@EIL', '@LEIL'], kind: 'meta', description: 'Targets entities in a line between the inherited target and the caster', insertSnippet: '@LivingInLine{r=1}' },
  { id: 'LivingNearTargetLocation', shorthand: ['@LNTL', '@ENT'], kind: 'meta', description: 'Targets all living entities near the inherited target', insertSnippet: '@LivingNearTargetLocation{r=5}' },
  ...
  { id: 'RandomLocationsNearTargets', shorthand: ['@RLNT'], kind: 'meta', description: 'Targets random locations around the inherited targets', insertSnippet: '@RandomLocationsNearTargets{r=3;amount=3}' },
  { id: 'FloorOfTargets', shorthand: ['@FOT'], kind: 'meta', description: 'Targets the blocks underneath the inherited targets', insertSnippet: '@FloorOfTargets' },
  { id: 'LocationsOfTargets', shorthand: ['@LOT'], kind: 'meta', description: 'Targets the location of the inherited target entities', insertSnippet: '@LocationsOfTargets' },
  { id: 'TargetedLocation', shorthand: ['@targetedLoc'], kind: 'meta', description: 'Targets the location of the inherited target locations', insertSnippet: '@TargetedLocation' },
